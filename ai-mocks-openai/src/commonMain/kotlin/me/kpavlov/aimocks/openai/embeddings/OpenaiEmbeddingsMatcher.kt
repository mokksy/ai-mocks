...
/**
 * Matcher for OpenAI string embedding requests.
 *
 * @param input The string input to match against OpenAI embedding requests.
...
/**
 * Matcher for OpenAI string list embedding requests.
 *
 * @param inputs The list of string inputs to match against OpenAI embedding requests.
 * @see <a href="https://platform.openai.com/docs/api-reference/embeddings/create#embeddings-create-input">input parameter</a>
 */
