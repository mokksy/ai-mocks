...
internal class SetTaskPushNotificationRequestBuilderTest {
    ...
    fun `should build SetTaskPushNotificationRequest with required parameters`() {
        // when
        val request = SetTaskPushNotificationRequestBuilder().apply {
            params {
                id = "task-123"
        ...
        request.params shouldBe TaskPushNotificationConfig(
            id = "task-123",
    ...
    fun `should throw exception when params is missing`() {
        ...
        assertFailsWith<IllegalArgumentException> {
            SetTaskPushNotificationRequestBuilder().apply {
                id = "request-123"
            }.build()
        }
    }
    ...
    fun `should build using companion object create function`() {
        // when
        val request = SetTaskPushNotificationRequest.create {
            id = "request-123"
            params {
                id = "task-123"
                pushNotificationConfig {
